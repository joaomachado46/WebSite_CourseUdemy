...
namespace WebAppMvcCore.Data
{
    ...
    {
        private WebAppMvcCoreContext _context;

        public SeddingService(WebAppMvcCoreContext context)
        {
            _context = context;
        }
        ...
        public void Seed()
        {
            ...
            Department d2 = new Department {Name = "Fashion", };
            Department d3 = new Department {Name = "Phones", };
            Department d4 = new Department {Name = "Cams", };
